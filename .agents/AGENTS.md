...
* **Mô tả hình ảnh (Image Captions):** Ngay dưới mỗi thẻ `<img>` minh họa, bắt buộc phải chèn thẻ mô tả nội dung ảnh bằng tiếng Việt chuẩn: `<p class="text-xs text-center text-slate-400 dark:text-slate-500 mt-2 italic font-normal">Hình: [Mô tả chi tiết nội dung hình ảnh]</p>`.
