...
const newPostString = `
  {
    title: "Các Lệnh Mặc Định Của Claude AI: Hướng Dẫn Chi Tiết A-Z",
    description: "Khám phá toàn bộ các lệnh mặc định của Claude AI như /explore, /style, /project, /artifact. Hướng dẫn cách dùng chi tiết giúp tối ưu hiệu suất làm việc của bạn.",
    slug: "cac-lenh-mac-dinh-claude-ai",
    category: "Công nghệ",
    date: "13/07/2026",
    readTime: "12 phút",
    badge: "Mới"
...
console.log("Updated blog/index.astro with new Claude AI commands post!");
...
const newSearchItems = [
  {
    "title": "Bài viết: Các Lệnh Mặc Định Của Claude AI: Hướng Dẫn Chi Tiết A-Z",
    "desc": "Khám phá toàn bộ các lệnh mặc định của Claude AI như /explore, /style, /project, /artifact. Hướng dẫn cách dùng chi tiết giúp tối ưu hiệu suất làm việc của bạn.",
    "url": "/blog/cac-lenh-mac-dinh-claude-ai/"
  }
];
...
const newSitemapUrls = `  <url>
    <loc>https://trolyso.online/blog/cac-lenh-mac-dinh-claude-ai/</loc>
